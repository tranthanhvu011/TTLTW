    ...
    <div class="main-content">
        ...
        <div class="single-table"
            ...
            <div class="table-responsive">
                <table id="table_log" class="table text-center">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        var rows = document.querySelectorAll("#table_log tbody tr");

        rows.forEach(function(row) {
            var level = row.getAttribute("data-level");
            var levelCell = row.querySelector(".log-level");

            switch(level) {
                case "INFO":
                    levelCell.style.color = "blue";
                    break;
                case "ALERT":
                    levelCell.style.color = "orange";
                    break;
                case "WARNING":
                    levelCell.style.color = "yellow";
                    break;
                case "DANGER":
